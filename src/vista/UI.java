...
public class UI extends JFrame {
	...
	private JButton btnDecrementoDemanda;
	private JButton btnIncrementoDemanda;
	...
	public UI() {
		...
		btnDecrementoDemanda.setBorder(new LineBorder(new Color(0, 0, 0), 7, true));
	...
	public JButton getBtnDecrementoDemanda() {
		return btnDecrementoDemanda;
	}

	public JButton getBtnIncrementoDemanda() {
		return btnIncrementoDemanda;
	}
